...
namespace WinFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void LoadMockData()
        {
            ...
            {
                Color.FromArgb(240, 240, 240),  // 淺灰
                Color.FromArgb(255, 248, 220),  // 淺米黃
                Color.FromArgb(230, 245, 255),  // 淺藍
                Color.FromArgb(240, 255, 240),  // 淺綠
                Color.FromArgb(255, 240, 245),  // 淺粉
                Color.FromArgb(245, 240, 255),  // 淺紫
                Color.FromArgb(255, 245, 230)   // 淺橙
            };
        ...
        private void SetupUI()
        {
            ...
            dgvTransactions.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = "Date", HeaderText = "日期", Width = 100, DefaultCellStyle = new DataGridViewCellStyle { Format = "MM/dd" } });
        ...
        private void BtnColorPicker_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < predefinedColors.Length; i++)
            {
                ...
                {
                    Size = new Size(50, 50),
                    Location = new Point(i * 55, 25),
                    BackColor = predefinedColors[i],
                    FlatStyle = FlatStyle.Flat,
                    Tag = predefinedColors[i],
                    Cursor = Cursors.Hand
                };
                ...
                // 如果是當前選擇的顏色，加粗邊框
                if (selectedColor == predefinedColors[i])
                {
                    colorBtn.FlatAppearance.BorderSize = 4;
            ...
            colorPanel.Controls.Add(lblInstruction);
            colorForm.Controls.Add(colorPanel);
            colorForm.Controls.Add(btnCancel);
            colorForm.CancelButton = btnCancel;
